        ...
        <div class="container mt-4">
            <div class="d-flex justify-content-center">
              <div class="col-md-10">
                  ...
                  <div class="row">
                  <div class="col">
                    <input value="{{ old('uzsiemimas') }}" type="text" class="form-control" placeholder="Užsiėmimas" aria-label="uzsiemimas" id="uzsiemimas" name="uzsiemimas">
                  </div>
                  <div class="col">
                    <input value="{{ old('priziurejimas') }}" type="text" class="form-control" placeholder="Prižiūrėjimas" aria-label="priziurejimas" id="priziurejimas" name="priziurejimas">
                  </div>
