    ...
    <body class="antialiased">
        ...
        <main>
            <div class="container mt-4">
                ...
                @if (session('message_freedom_edit'))
                  <div class="alert alert-success">{{session('message_freedom_edit')}}</div>
                @endif
                @if (session('message_freedom_delete'))
                  <div class="alert alert-success">{{session('message_freedom_delete')}}</div>
                @endif
                <h1 class="about_pavadinimas text-center p-4">Visas laisvumas</h1>
                <div class="row justify-content-center paieska">
                    <div class="col-lg-4 ">
                    <form action="/all_working_days/search" method="get">
                ...
                <table class="table table_stilius">
                    <thead class="table1">
                      <tr>
                        <th scope="col">#</th>
                        <th scope="col" class="th_stilius">Data</th>
                        <th scope="col" class="th_stilius">Laikas</th>
                        <th scope="col" class="th_stilius"></th>
                ...
                @foreach ( $freedoms as  $freedoms2)
                    <tr class="tr_stilius">
                        ...
                        <td class="th_stilius">{{$freedoms2->date}}</td>
                        <td class="th_stilius">{{$freedoms2->time }}</td>
