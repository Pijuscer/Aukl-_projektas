        ...
        <main>
            <div class="container mt-4">
                ...
                <div class="row justify-content-center paieska">
                    <div class="col-lg-4 ">
                    <form action="/all_kids_profiles/search" method="get">
                ...
                <table class="table table_stilius" style="table-layout: fixed;">
                    <thead class="table1">
                      <tr>
                        <th scope="col">#</th>
                        <th scope="col" class="th_stilius">Vartotojo profilis</th>
                        <th scope="col" class="th_stilius">Vaiko vardas</th>
                        <th scope="col" class="th_stilius">Vaiko pavardė</th>
                        <th scope="col" class="th_stilius">Gimimo data</th>
                ...
                @foreach ( $kids_profiles as  $kids_profiles2)
                    <tr class="tr_stilius">
                        ...
                        <td class="th_stilius">{{$kids_profiles2->user_profile_id }}</td>
                        <td class="th_stilius">{{$kids_profiles2->kid_name }}</td>
                        <td class="th_stilius">{{$kids_profiles2->kid_surname }}</td>
                        <td class="th_stilius">{{$kids_profiles2->date_of_birth}}</td>
                        <td class="th_stilius">{{$kids_profiles2->additional_information }}</td>
